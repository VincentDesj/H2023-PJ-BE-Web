...
app.use((req, res, next) => {
    res.setHeader(
        ...
        "default-src 'self'; script-src 'self'; style-src 'self'; font-src 'self'; img-src 'self'; frame-src 'self'; frame-ancestors 'none'"
    );
...
let serveur = app.listen(process.env.PORT || 3001, () => {
